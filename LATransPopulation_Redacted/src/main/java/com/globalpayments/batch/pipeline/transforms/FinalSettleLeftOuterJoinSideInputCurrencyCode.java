...
public class FinalSettleLeftOuterJoinSideInputCurrencyCode  extends DoFn<TableRow, TableRow>
{
	...
	public FinalSettleLeftOuterJoinSideInputCurrencyCode(String leftKey, String rightKey,
